...
func TestShouldReturnDomainErrorIfNameIsEmpty(t *testing.T) {
	//Arrange
	expectedCode := shared2.BadRequest
	expectedMessage := `The field 'name' is required in 'User'`

	//Act
	id, _ := shared2.NewID("test-sa-id")
	_, err := user2.NewFirstSuperAdmin(id, "", "any_email", "any_username", "any_password")
...
func TestShouldReturnDomainErrorIfEmailIsEmpty(t *testing.T) {
	...
	//Atc
	id, _ := shared2.NewID("test-sa-id")
	_, err := user2.NewFirstSuperAdmin(id, "any_name", "", "any_username", "any_password")
...
func TestShouldReturnDomainErrorIfUsernamesEmpty(t *testing.T) {
	...
	//Atc
	id, _ := shared2.NewID("test-sa-id")
	_, err := user2.NewFirstSuperAdmin(id, "any_name", "any_email", "", "any_password")
...
func TestShouldReturnDomainErrorIfPasswordIsEmpty(t *testing.T) {
	...
	//Atc
	id, _ := shared2.NewID("test-sa-id")
	_, err := user2.NewFirstSuperAdmin(id, "any_name", "any_email", "any_username", "")
...
func TestShouldReturnUserWithCorrectValues(t *testing.T) {
	//Atc 	//Arrange
	id, _ := shared2.NewID("test-sa-id")
	us, err := user2.NewFirstSuperAdmin(id, "any_name", "any_email", "any_username", "any_passq")
